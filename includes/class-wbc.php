...
class Wbc {
	...
	public function __construct() {
		if ( defined( 'WBC_VERSION' ) ) {
			$this->version = WBC_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'wbc';
	 ...
	 *
	 * - Wbc_Loader. Orchestrates the hooks of the plugin.
	 * - Wbc_i18n. Defines internationalization functionality.
	 * - Wbc_Admin. Defines all hooks for the admin area.
	 * - Wbc_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wbc-loader.php';
		 ...
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-wbc-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-wbc-public.php';

		$this->loader = new Wbc_Loader();
	 ...
	 *
	 * Uses the Wbc_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Wbc_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Wbc_Public( $this->get_plugin_name(), $this->get_version() );
